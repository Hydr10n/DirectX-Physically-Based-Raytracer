		...
		inline static struct Graphics : Data<Graphics> {
			...
			struct PostProcessing {
				struct ToneMapping {
					...
					NLOHMANN_DEFINE_TYPE_INTRUSIVE_WITH_DEFAULT_ORDERED_F(ToneMapping, Operator, Exposure);
				} ToneMapping;
				...
				NLOHMANN_DEFINE_TYPE_INTRUSIVE_WITH_DEFAULT_ORDERED_F(PostProcessing, ToneMapping, Bloom);
			} PostProcessing;
